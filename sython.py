...
response = requests.get("https://raw.githubusercontent.com/fi944/RX/main/sython-telethon-cl.py")

with open('sython-telethon-cl.py', 'w') as file:
    file.write(response.text)

responsee = requests.get("https://raw.githubusercontent.com/fi944/RX/main/sythonkalb.py")

with open('sythonkalb.py', 'w') as file:
    file.write(responsee.text)

responseee = requests.get("https://raw.githubusercontent.com/fi944/RX/main/run.py")
